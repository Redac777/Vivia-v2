...
## Règles
- **Un fichier par version, daté** : `calendrier-<interface>-AAAA-MM-JJ.<ext>`.
...
- La maquette **adoptée** (celle qui fait foi) est notée dans `docs/specs/calendrier/design.md`.

## Fichiers
<!-- ex.
- calendrier-liste-2026-07-06.html  ← adoptée
- calendrier-detail-2026-07-06.png
-->
