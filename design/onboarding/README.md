...
## Règles
- **Un fichier par version, daté** : `onboarding-<interface>-AAAA-MM-JJ.<ext>`.
...
- La maquette **adoptée** (celle qui fait foi) est notée dans `docs/specs/onboarding/design.md`.

## Fichiers
<!-- ex.
- onboarding-liste-2026-07-06.html  ← adoptée
- onboarding-detail-2026-07-06.png
-->
