...
## Règles
- **Un fichier par version, daté** : `chat-<interface>-AAAA-MM-JJ.<ext>`.
...
- La maquette **adoptée** (celle qui fait foi) est notée dans `docs/specs/chat/design.md`.

## Fichiers
<!-- ex.
- chat-liste-2026-07-06.html  ← adoptée
- chat-detail-2026-07-06.png
-->
