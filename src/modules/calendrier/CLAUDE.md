...
## Rôle
Mois, détail RDV et nouveau RDV (CRUD).

- **Owner** : @amine
- **Dépendances autorisées** : auth (via leur API publique `index.ts` uniquement)
...
## Où est quoi
- Spec : `docs/specs/calendrier/spec.md` (+ `plan.md`, `design.md`, `test-plan.md`)
- Design / maquettes : `design/calendrier/`
