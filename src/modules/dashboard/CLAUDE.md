...
## Rôle
Écran d'accueil qui agrège tâches, calendrier et stocks.

- **Owner** : @sara
- **Dépendances autorisées** : taches, calendrier, stocks (via leur API publique `index.ts` uniquement)
...
## Où est quoi
- Spec : `docs/specs/dashboard/spec.md` (+ `plan.md`, `design.md`, `test-plan.md`)
- Design / maquettes : `design/dashboard/`
